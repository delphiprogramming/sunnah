...
if (Meteor.isServer) {
	Meteor.startup(function () {
		...
		if (Stext.find({}).count() === 0) {
			...
			Stext.insert({section: 1, order: 12, ref: 'mmp', label: 'Menu: My Profile', en: 'My Profile', id: 'Profilku'});
			Stext.insert({section: 1, order: 13, ref: 'msn', label: 'Menu: SNAP', en: 'Social Networks', id: 'Sosial Network'});
			Stext.insert({section: 1, order: 14, ref: 'mad', label: 'Menu: Admin', en: 'Admin', id: 'Admin'});
			Stext.insert({section: 1, order: 15, ref: 'fuo', label: 'Footer: Follow', en: 'Follow us on:', id: 'Ikuti kita di:'});
			...
			Stext.insert({section: 4, order: 7, ref: 'qam', label: 'Quran Admin Message', en: 'ADMIN: You can edit the Quran information below and edit the content until it is ready for the public.', id: 'ADMIN: Anda dapat mengedit informasi Quran di bawah ini dan mengedit konten sampai siap untuk publik.'});
		}
	});
}
