...
FlowRouter.route('/quran/:surah/:ayah?', {
	name: 'quranSurah',
	action: function () {
		BlazeLayout.render("layout", {page: 'quranSurah'});
		$('body').css('background','url(/bg.jpg)');
	}
});
...
FlowRouter.route('/tools/api', {
	name: 'toolsApi',
	action: function () {
		BlazeLayout.render("layout", {page: 'toolsApi'});
		$('body').css('background','url(/bg.jpg)');
	}
});

FlowRouter.route('/tools/pray', {
	name: 'toolsPray',
	action: function () {
		BlazeLayout.render("layout", {page: 'toolsPray'});
		$('body').css('background','url(/bg.jpg)');
	}
});
...
FlowRouter.route('/admin/translate/languages', {
	name: 'adminUsers',
	action: function () {
		BlazeLayout.render("layout", {page: 'adminTranslateLanguages'});
		$('body').css('background','url(/bg.jpg)');
	}
});

FlowRouter.route('/admin/translate/sitetext', {
	name: 'adminUsers',
	action: function () {
		BlazeLayout.render("layout", {page: 'adminTranslateSitetext'});
		$('body').css('background','url(/bg.jpg)');
	}
});
